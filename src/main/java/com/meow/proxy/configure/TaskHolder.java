...
public class TaskHolder {
	...
	private TaskHolder() {
		taskList.add(new Task("http://www.xicidaili.com/",true,4,XicidailiDownLoader.class.getCanonicalName(), XicidailiExtractor.class.getCanonicalName(), ProxySite.xicidaili.getProxySiteName()));
	}
